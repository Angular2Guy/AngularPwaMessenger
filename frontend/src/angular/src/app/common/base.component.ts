...
export class BaseComponent implements OnInit, AfterViewInit {
    ...
    constructor(protected mediaMatcher: MediaMatcher, protected localdbService: LocaldbService,
    protected jwttokenService: JwtTokenService, protected contactService: ContactService) {}
